...
$SHADOWPLANELOCATION";
        ...
        public void DefaultValuesTest()
        {
            ...
            Assert.Empty(header.AlternateDimensioningSuffix);
            ...
            Assert.Empty(header.ArrowBlockName);
            ...
            Assert.Empty(header.DimensionFirstExtensionLineType);
            ...
            Assert.Empty(header.DimensionLineType);
            ...
            Assert.Empty(header.DimensionSecondExtensionLineType);
            ...
            Assert.Empty(header.FirstArrowBlockName);
            ...
            Assert.Empty(header.HyperlinkBase);
            ...
            Assert.Empty(header.LastSavedBy);
            ...
            Assert.Empty(header.OrthoUCSReference);
            ...
            Assert.Empty(header.PaperspaceOrthoUCSReference);
            Assert.Empty(header.PaperspaceUCSDefinitionName);
            Assert.Empty(header.PaperspaceUCSName);
            ...
            Assert.Empty(header.ProjectName);
            ...
            Assert.Empty(header.SecondArrowBlockName);
            ...
            Assert.Empty(header.Stylesheet);
            ...
            Assert.Empty(header.UCSDefinitionName);
            Assert.Empty(header.UCSName);
